...
const ChatPage = () => {
  ...
  const handleConversationSearch = async (e) => {
    ...
    try {
      const res = await fetch(`/api/user/profile/?search=${searchText}`);
      ...
      if (searchedUser.error) {
       ...
       if (
         searchedUser.success === false &&
         searchedUser.status === "failure"
       ) {
      ...
      const conversationAlreadyExists = conversations.find(
        (conversation) => conversation.participants[0]._id === searchedUser.data._id
      );
